...
Once you're done, modify `App.js` to render your new component at the indicated location. Then, test your code by running it using `yarn run start`, if you aren't already doing so.
